...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { item_desc: @menu_item.item_desc, item_name: @menu_item.item_name, price: @menu_item.price, restaurant_id: @menu_item.restaurant_id }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { item_desc: @menu_item.item_desc, item_name: @menu_item.item_name, price: @menu_item.price, restaurant_id: @menu_item.restaurant_id }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
