...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { paid_at: @check.paid_at, restaurant_id: @check.restaurant_id, user_id: @check.user_id }
    end
  ...
  test "should update check" do
    patch :update, id: @check, check: { paid_at: @check.paid_at, restaurant_id: @check.restaurant_id, user_id: @check.user_id }
    assert_redirected_to check_path(assigns(:check))
  end
